...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "checkinms@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "checkinms API";

        private String description = "checkinms API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "checkinms";
