...
import com.bfa.checkinms.CheckinmsApp;

import com.bfa.checkinms.config.SecurityBeanOverrideConfiguration;
...
@SpringBootTest(classes = {CheckinmsApp.class, SecurityBeanOverrideConfiguration.class})
